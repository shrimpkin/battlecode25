package V09Eco.Units;

import V09Eco.Comms;
import V09Eco.Unit;
import V09Eco.Micro.SoldierMicro;
...
public class Soldier extends Unit {
    ...
    public static void updateSRPTarget() throws GameActionException {
        ...
        for(MapInfo info : rc.senseNearbyMapInfos()) {
            ...
            if(isValidSRPPosition(loc) && (SRPTarget == null || rc.getLocation().distanceSquaredTo(loc) < rc.getLocation().distanceSquaredTo(SRPTarget))) {
                SRPTarget = loc;
            }
        }
    }
    ...
    public static void paintBuildTarget() throws GameActionException {
        ...
        if(bMode == BuildMode.BUILD_SRP) {
            ...
            if(rc.getChips() >= 3000) {
                ...
                buildType = UnitType.LEVEL_ONE_MONEY_TOWER;
            }
