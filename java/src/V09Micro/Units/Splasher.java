...
import V09Micro.Micro.SplasherMicro;
...
public class Splasher extends Unit {
    ...
    /// Updates splashUtil and splashTarget fields
    public static MapLocation updateSplashTarget() throws GameActionException {
    ...
    /** Splashes the best target location if it has sufficient util */
    public static boolean splash() throws GameActionException {
       if(splashTarget == null) return false;
    ...
    public static void move() throws GameActionException {
        ...
        boolean isEnemyTowers = false;
        for(RobotInfo info : rc.senseNearbyRobots(-1, opponentTeam)) {
        ...
        if(splashTarget != null) rc.setIndicatorDot(splashTarget, 0, 0, 0);
        if(isEnemyTowers) {
