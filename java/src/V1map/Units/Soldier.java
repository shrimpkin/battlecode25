...
public class Soldier extends Unit {
    ...
    public static void run() throws GameActionException {
        ...
        switch(mo) {
            case LOW_PAINT: rc.setIndicatorString(indicator + " Low Paint");
            case RUIN_BUILDING: rc.setIndicatorString(indicator + " Ruin Building");
            case RUIN_FINDING: rc.setIndicatorString(indicator + " Ruin Finding");
        }
    }
