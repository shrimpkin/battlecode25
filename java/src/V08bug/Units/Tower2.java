// package V08bug.Units;

// import V08bug.Comms;
// import V08bug.Unit;
// import V08bug.Tools.CommType;
...
//         if (rc.getNumberTowers() <= 4 || numSoldiersSpawned <= (8 * mapHeight * mapWidth / 3200.0)) {
//             buildRobotType(UnitType.SOLDIER);
//             return;
//         }
...
//         if (rc.getChips() > 800 && allies.length < 10) {
//             if (nextDouble() < 0.9) {
//                 if (nextDouble() < (rc.getRoundNum() / 2000.0) / (mapHeight * mapWidth / 3200.0 / 2)) {
//                     buildRobotType(UnitType.SPLASHER);
//                 } else {
//                     if (rc.getChips() > 300 && rc.getPaint() > 300) {
//                         buildRobotType(UnitType.MOPPER);
